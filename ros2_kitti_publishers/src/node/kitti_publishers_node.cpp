...
: Node("publisher_node"), file_index_(0)
{
  ...
  publisher_point_cloud_ = this->create_publisher<sensor_msgs::msg::PointCloud2>("/kitti/point_cloud", 1);
  publisher_image_gray_left_ = this->create_publisher<sensor_msgs::msg::Image>("kitti/image/gray/left", 1);
  publisher_image_gray_right_ = this->create_publisher<sensor_msgs::msg::Image>("kitti/image/gray/right", 1);
  publisher_image_color_left_ = this->create_publisher<sensor_msgs::msg::Image>("kitti/image/color/left", 1);
  publisher_image_color_right_ = this->create_publisher<sensor_msgs::msg::Image>("kitti/image/color/right", 1);
  publisher_imu_ = this->create_publisher<sensor_msgs::msg::Imu>("kitti/imu", 1);
  publisher_nav_sat_fix_= this->create_publisher<sensor_msgs::msg::NavSatFix>("kitti/nav_sat_fix", 1);
  publisher_marker_array_ = this->create_publisher<visualization_msgs::msg::MarkerArray>("kitti/marker_array", 1);
...
{
    path_point_cloud_ = "data/2011_10_03/2011_10_03_drive_0042_sync/velodyne_points/data/";
    path_image_gray_left_ = "data/2011_10_03/2011_10_03_drive_0042_sync/image_00/data/";
    path_image_gray_right_ = "data/2011_10_03/2011_10_03_drive_0042_sync/image_01/data/";
    path_image_color_left_ = "data/2011_10_03/2011_10_03_drive_0042_sync/image_02/data/";
    path_image_color_right_ = "data/2011_10_03/2011_10_03_drive_0042_sync/image_03/data/";
    path_oxts_ = "data/2011_10_03/2011_10_03_drive_0042_sync/oxts/data/";
}
